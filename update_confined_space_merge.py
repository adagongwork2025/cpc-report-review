#!/usr/bin/env python3
"""
更新局限空間的合併邏輯，讓同一 ID 的多種違規類型都顯示在同一張卡片上
"""

import re
from datetime import datetime, timedelta

# 需要更新 generate_daily_review.py 中的 consolidate_confined_space_logs 函式
...
print("=" * 70)
print("\n主要變更：")
print("1. 將 confined_person、heartbeat、harness 視為人員相關違規")
print("2. 同一個 ID 在 30 分鐘內的多種違規類型會合併為一筆")
print("3. 合併後的記錄會列出所有違規類型")
print("\n範例：")
print("  ID:425 在 15:14:05 有兩筆違規：")
print("  - 缺少生命偵測器 (heartbeat)")
print("  - 缺少安全帶 (harness)")
print("  合併後顯示：缺少生命偵測器、缺少安全帶 ID:425")
print("\n" + "=" * 70)
print("\n新函式程式碼：\n")
print(new_function)
