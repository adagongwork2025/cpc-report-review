...
# 讀取 API 資料
with open('/tmp/758_deduped_0413.json', 'r') as f:
    data_758 = json.load(f)

with open('/tmp/867_deduped_0413.json', 'r') as f:
    data_867 = json.load(f)

print(f"Camera 758 資料筆數: {len(data_758)}")
print(f"Camera 867 資料筆數: {len(data_867)}")
...
with open(f'{output_dir}/高處A_審核.html', 'w', encoding='utf-8') as f:
    f.write(html_a)
print(f"✓ 已產生 高處A_審核.html (Camera 867, 從 {data_867_processed[0]['time_display']} 開始)")
